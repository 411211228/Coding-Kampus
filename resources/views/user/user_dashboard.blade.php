...
<head>
    ...
    <title>helpdesk.undia.ac.id </title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('backend/assets/images/UNDIRA-D.png')}}">
	<link rel="stylesheet" href="{{asset('a1/vendor/chartist/css/chartist.min.css')}}">
    <link href="{{asset('a1/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
	<link href="{{asset('a1/vendor/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{asset('a1/css/style.css')}}" rel="stylesheet">
...
@yield('user')
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script data-cfasync="false" src=".{{asset('a1/./cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script src="{{asset('a1/vendor/global/global.min.js')}}"></script>
	<script src="{{asset('a1/vendor/bootstrap-select/dist/js/bootstrap-select.min.js')}}"></script>
	<script src="{{asset('a1/vendor/chart.js/Chart.bundle.min.js')}}"></script>
	
	<!-- Chart piety plugin files -->
    <script src="{{asset('a1/vendor/peity/jquery.peity.min.js')}}"></script>
	
	<!-- Apex Chart -->
	<script src="{{asset('a1/vendor/apexchart/apexchart.js')}}"></script>
	
	<!-- Dashboard 1 -->
	<script src="{{asset('a1/js/dashboard/dashboard-1.js')}}"></script>
	
	<script src="{{asset('a1/vendor/owl-carousel/owl.carousel.js')}}"></script>
    <script src="{{asset('a1/js/custom.min.js')}}"></script>
	<script src="{{asset('a1/js/deznav-init.js')}}"></script>
    <script src="{{asset('a1/js/demo.js')}}"></script>
    <script src="{{asset('a1/js/styleSwitcher.js')}}"></script>
