                                  ...
                                  <form method="POST" action="{{ route('store.type')}}" class="forms-sample" >
                                    @csrf
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <input type="text" name="type_name" class="form-control @error('old_password')is-invalid @enderror"  >
                                          @error('type_name')
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <input type="text" name="type_icon" class="form-control @error('old_password')is-invalid @enderror"  >
                                        @error('type_icon')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
