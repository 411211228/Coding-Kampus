        ...
        <div class="card rounded">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-2">
              ...
              <div class="wd-100 rounded-circle" style="width: 100px; height: 100px; overflow: hidden;">
                <img src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.JPG') }} " alt="profile"  style="width: 100%; height: auto;">
                <span class="h4 ms-3 ">{{$profileData->name}}</span>
              </div>


            </div>
            <p>Hi! I'm Ilham the Senior IT suport at Universitas Dian Nusantara. We hope you enjoy the design and quality of Social.</p>
            <div class="mt-3">
            ...
            <div class="mt-3">
              <label class="tx-11 fw-bolder mb-0 text-uppercase">Addres:</label>
                ...
                <div class="card-body">
                   ...
                   <h6 class="card-title">Admin Change Password</h6>
                                  ...
                                  <form method="POST" action="{{ route('admin.update.password')}}" class="forms-sample" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Confrim New Password</label>
